...
describe('preprocessHarEntries', () => {
  ...
  it('should return true for identical recordings', () => {
    let a = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording1.har'), 'utf8'));
    let b = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording1.har'), 'utf8'));
    assert.deepEqual(a, b)
  });

  it('should return true for recordings generated by the same AJS on the same website', () => {
    let a = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording1.har'), 'utf8'));
    let b = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording2.har'), 'utf8'));
    assert.deepEqual(a, b)
  });

  it('should return false for recordings generated by different AJS configurations on the same website', () => {
    let a = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording1.har'), 'utf8'));
    let b = preprocessHarEntries(fs.readFileSync(path.join(__dirname, 'test_data', 'recording3.har'), 'utf8'));
