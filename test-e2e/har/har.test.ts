...
import { parseHttpArchiveText, compareEntries, isEquivalent, HarEntry } from './har'
import fs from 'fs';
...
describe('compareEntries', () => {
  ...
  it('should ignore user-agent headers', () => {
    assert(compareEntries(
      [{request: {headers: [{name: 'user-agent', value: 'foo'}]}} as HarEntry],
      [{request: {headers: [{name: 'user-agent', value: 'bar'}]}} as HarEntry],
    ))
  })
});
