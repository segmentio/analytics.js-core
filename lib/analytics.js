...
Analytics.prototype.init = Analytics.prototype.initialize = function(
  ...
  var self = this;
  each(function(setting, configId) {
    var name = configId === 'Segment.io' ? 'Segment.io' : setting.name;
  ...
  each(function(setting, configId) {
    ...
    var name = configId === 'Segment.io' ? configId : setting.name;
    var opts = configId === 'Segment.io' ? setting : setting.opts;
    ...
    var Integration = self.Integrations[name];
    if (!Integration || typeof Integration !== 'function') {
      return;
    }
    var clonedOpts = {};
    ...
    self.add(integration, configId, name);
  }, settings);
  ...
  each(function(configId) {
    var integration = configId.integration;
    if (
...
Analytics.prototype.add = function(integration, configId, name) {
  this._integrations[configId] = {
