...
const Alias = require('segmentio-facade').Alias;
const Emitter = require('component-emitter');
const Facade = require('segmentio-facade');
const Group = require('segmentio-facade').Group;
const Identify = require('segmentio-facade').Identify;
const SourceMiddlewareChain = require('./middleware').SourceMiddlewareChain;
const IntegrationMiddlewareChain = require('./middleware')
  .IntegrationMiddlewareChain;
const Page = require('segmentio-facade').Page;
const Track = require('segmentio-facade').Track;
...
const foldl = require('@ndhoule/foldl');
const group = require('./group');
const is = require('is');
const isMeta = require('@segment/is-meta');
const keys = require('@ndhoule/keys');
const memory = require('./memory');
const nextTick = require('next-tick');
const normalize = require('./normalize');
const on = require('component-event').bind;
const pageDefaults = require('./pageDefaults');
const pick = require('@ndhoule/pick');
const prevent = require('@segment/prevent-default');
const querystring = require('component-querystring');
...
Analytics.prototype.init = Analytics.prototype.initialize = function(
  ...
  each(integration => {
    if (
      ...
      integration.page = function(...args) {
...
Analytics.prototype.page = function(category, name, properties, options, fn) {
  ...
  const overrides = pick(keys(defs), properties);
