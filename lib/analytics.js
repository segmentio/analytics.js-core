...
/**
 * Used for stubbing navigator.doNotTrack in the unit tests.
 */

Analytics._doNotTrack = function() {
  // Fallback to window.doNotTrack in older browsers
  var doNotTrack = navigator.doNotTrack || window.doNotTrack;
  // Normalize values (Firefox can return 'unspecified')
  return doNotTrack === '1' ? '1' : '0';
};
...
Analytics.prototype.init = Analytics.prototype.initialize = function(settings, options) {
  ...
  this._readied = false;
  var doNotTrack = options.doNotTrack && Analytics._doNotTrack() === '1';
  ...
  if (doNotTrack) {
    // Clear manually added integrations
    this._integrations = {};
  } else {
    // add integrations
    each(function(opts, name) {
...
Analytics.prototype.normalize = function(msg) {
  ...
  msg.context.doNotTrack = Analytics._doNotTrack();
