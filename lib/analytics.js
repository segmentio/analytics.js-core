 ...
 * Destination Middleware and Integration middleware cannot be chained together.
 *
 * @param {Function} Middleware
 * @return {Analytics}
 */
  ...
  middlewares.forEach(function(middleware) {
    if (!self._destinationMiddlewares[integrationName]) {
      self._destinationMiddlewares[
        integrationName
      ] = new IntegrationMiddlewareChain();
    }
...
=======
              storedResult = result;
>>>>>>> feat: tweak applyIntegrationMiddlewares
            }
          );
          ...
          integration.invoke.call(integration.name, method, storedResult);
        } catch (e) {
          metrics.increment('analytics_js.integration.invoke.error', {
            method: method,
            integration_name: integration.name
